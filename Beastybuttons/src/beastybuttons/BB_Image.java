...
//ERROR: THROWS NULL ERROR WHEN ADDED TO BEASTYWORLD
@Experimental
public class BB_Image extends Widget
{
	...
	public BB_Image(PApplet ref, PImage img) {
		this.REF = ref;
		this.IMG = img;
  ...
  //generate the colors after sketch can be referenced
    ...
    public BB_Image cropImage(String edge, int pixel_amount) {
    	PApplet.println("WARNING(BB): CROPIMAGE() IS STILL HIHGLY EXPERIMENTAL, AVOID USE IF POSSIBLE");
    	PImage newimg;
    	float pixel_size;
