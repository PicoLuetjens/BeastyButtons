...
public class Inputfield_asos extends Widget
{
    ...
    Inputfield_asos(PApplet p, int li, int sizex, int sizey)
    {
        this.sketch = p;
    ...
    Inputfield_asos(PApplet p, int li, int sizex, int sizey, boolean round)
    {
        this.sketch = p;
        this.longest_input = li;
        this.sizes[0] = sizex;
    ...
    {
        String convert = String.valueOf(Inputfield_asos.i_instances);
        this.id = "inputfield_asos" + convert;
        Inputfield_asos.i_instances+=1;
